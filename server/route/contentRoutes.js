const {createContent,querySearchAll,getUserContents,getAllContents,getOneContent,editProjects,HashAllContents,searchUserContent,querySearchText} = require('../controller/contentController')
